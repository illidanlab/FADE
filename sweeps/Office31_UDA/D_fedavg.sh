...
load_model.hash_name=Office31D/FedAvg/OfficeCnnSplit/c131bb220bfae6defe855b253afbcb6788da0dc1/g_0
"
# dropout bottleneck: 0190b6bc823de135d22e99960783dbcd1ec8cc1d
# bn battleneck: c131bb220bfae6defe855b253afbcb6788da0dc1
#echo =====
...
python -m dmtl.mainx $kwargs $kwargs_multi_select logger.wandb.group='${server.name}-u${dataset.n_user}-lr${user.optimizer.learning_rate}' $data_kwargs   $load_kwargs action=eval dataset.name=Office31W logger.loggers='[]'
# $data_kwargs_multi_select